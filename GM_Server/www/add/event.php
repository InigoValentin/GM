...
<html>
	...
	<body>
		...
		<a href="people.php">Añadir organizaciones</a> - <a href="place.php">Añadir lugares</a> - <a href="gmevent.php">Añadir actividades de margolariak</a>
		<br/><br/>
		<h3>Ultimos 10:</h3>
		<?php
		...
		<p style='width:500px;margin-left:15px;'>Los campos <i>Termina</i> y <i>Organiza</i> no son obligatorios. El resto si.<br/><br/>
			...
			Si cometieras algun error, deja de anadir y contacta con el administrador.
		</p>
		<?php
